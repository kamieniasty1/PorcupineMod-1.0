package com.kamieniasty.porcupinemod.entity.custom;

import com.kamieniasty.porcupinemod.entity.ModEntities;
import com.kamieniasty.porcupinemod.entity.ai.PorcupineAttackGoal;
...
public class PorcupineEntity extends Animal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new PorcupineAttackGoal(this, 2.0D, true));

        this.goalSelector.addGoal(1, new BreedGoal(this, 2D));
        this.goalSelector.addGoal(2, new TemptGoal(this, 1.5D, Ingredient.of(Items.WHEAT), false));

        this.goalSelector.addGoal(3, new FollowParentGoal(this, 1.8D));
