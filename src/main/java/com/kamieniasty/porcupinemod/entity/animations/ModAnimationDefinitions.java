package com.kamieniasty.porcupinemod.entity.animations;
...
public class ModAnimationDefinitions {
    ...
    public static final AnimationDefinition PORCUPINE_WALK = AnimationDefinition.Builder.withLength(2.5f).looping()
            .addAnimation("torso",
                    new AnimationChannel(AnimationChannel.Targets.POSITION,
                            ...
                            new Keyframe(0.4167667f, KeyframeAnimations.posVec(0f, 0f, -0.05f),
                                    AnimationChannel.Interpolations.LINEAR),
    ...
    public static final AnimationDefinition PORCUPINE_IDLE = AnimationDefinition.Builder.withLength(2.4583435f).looping()
            .addAnimation("torso",
                    new AnimationChannel(AnimationChannel.Targets.POSITION,
                            new Keyframe(0f, KeyframeAnimations.posVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
            ...
            .addAnimation("tail",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            new Keyframe(0f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
                            new Keyframe(0.5f, KeyframeAnimations.degreeVec(4.93f, 4.7f, -1.71f),
                                    AnimationChannel.Interpolations.LINEAR),
                            new Keyframe(0.875f, KeyframeAnimations.degreeVec(4.98f, -2.35f, 0.86f),
                                    AnimationChannel.Interpolations.LINEAR),
                            new Keyframe(1.25f, KeyframeAnimations.degreeVec(4.84f, -7.04f, 2.58f),
                                    AnimationChannel.Interpolations.LINEAR),
                            new Keyframe(1.5f, KeyframeAnimations.degreeVec(4.84f, -7.04f, 2.58f),
                                    AnimationChannel.Interpolations.LINEAR),
                            new Keyframe(1.875f, KeyframeAnimations.degreeVec(4.98f, -2.35f, 0.86f),
                                    AnimationChannel.Interpolations.LINEAR),
                            new Keyframe(2.2083435f, KeyframeAnimations.degreeVec(4.93f, 4.7f, -1.71f),
                                    AnimationChannel.Interpolations.LINEAR),
                            new Keyframe(2.4583435f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR))).build();
